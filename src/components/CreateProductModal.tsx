...
export default function CreateProductModal({ isOpen, onClose, onAddProduct, isInline = false }: CreateProductModalProps) {
  ...
  const formContent = (
    <div className={`relative w-full ${isInline ? 'max-w-xl' : 'max-w-md max-h-[92vh]'} overflow-hidden rounded-none bg-white shadow-xl border border-zinc-200 flex flex-col text-left animate-slide-up`}>
      ...
      {/* Modal Header */}
      <div className="p-5 px-6 border-b border-zinc-200 bg-zinc-950 text-white flex justify-between items-center shrink-0">
        <div>
      ...
      <form onSubmit={handleSubmit} className="p-6 space-y-5 overflow-y-auto flex-1 text-zinc-800">
        ...
        <div className="space-y-4">
          ...
          {/* Standard inputs */}
          <div>
            <label htmlFor="style-name" className="block text-[8px] font-bold text-zinc-400 uppercase tracking-widest mb-1.5">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label htmlFor="style-gender" className="block text-[8px] font-bold text-zinc-400 uppercase tracking-widest mb-1.5">
                Gender Selector
              </label>
              <select
                id="style-gender"
            ...
            <div>
              <label htmlFor="style-age" className="block text-[8px] font-bold text-zinc-400 uppercase tracking-widest mb-1.5">
                Age Bracket
              </label>
              <select
                id="style-age"
          ...
          <div className="grid grid-cols-1 gap-2">
            <div>
              <label htmlFor="style-category" className="block text-[8px] font-bold text-zinc-400 uppercase tracking-widest mb-1.5">
                Category *
              </label>
              <input
                type="text"
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label htmlFor="style-pricemin" className="block text-[8px] font-bold text-zinc-400 uppercase tracking-widest mb-1.5">
                Min Range (₹) *
              </label>
              <input
                type="number"
            ...
            <div>
              <label htmlFor="style-pricemax" className="block text-[8px] font-bold text-zinc-400 uppercase tracking-widest mb-1.5">
                Max Range (₹) *
              </label>
              <input
                type="number"
          ...
          {/* Sizes */}
          <div>
            <label htmlFor="style-sizes" className="block text-[8px] font-bold text-zinc-400 uppercase tracking-widest mb-1.5">
          ...
          {/* Colors */}
          <div>
            <label htmlFor="style-colors" className="block text-[8px] font-bold text-zinc-400 uppercase tracking-widest mb-1.5">
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-4 bg-zinc-950/70 backdrop-blur-xs transition-opacity overflow-y-auto">
      {formContent}
    </div>
  );
}
